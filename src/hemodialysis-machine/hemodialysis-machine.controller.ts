...
export class HemodialysisMachineController {
  ...
  create(@Body() data: CreateHemodialysisMachineDto) {
    let params: Prisma.HemodialysisMachineCreateArgs = {
  ...
  findAll(@Query('take') take: number = 0, @Query('page') p: number = 0) {
    let params: Prisma.HemodialysisMachineFindManyArgs = {
      include: this.hemodialysisMachineService.hemodialysis_machine_include,
      orderBy: [
        {
          hemodialysis: {
  ...
  findOne(@Param('id') id: string) {
    let params: Prisma.HemodialysisMachineFindUniqueArgs = {
      where: { id: id },
      include: this.hemodialysisMachineService.hemodialysis_machine_include,
    };
  ...
  update(@Param('id') id: string, @Body() data: UpdateHemodialysisMachineDto) {
    let params: Prisma.HemodialysisMachineUpdateArgs = {
      where: { id: id },
  ...
  remove(@Param('id') id: string) {
    let params: Prisma.HemodialysisMachineDeleteArgs = {
      where: { id: id },
      include: this.hemodialysisMachineService.hemodialysis_machine_include,
    };
