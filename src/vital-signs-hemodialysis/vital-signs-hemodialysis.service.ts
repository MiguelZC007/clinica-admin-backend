...
export class VitalSignsHemodialysisService {
  ...
  async findMany(params: Prisma.VitalSignsHemodialysisFindManyArgs) {
    try {
      const response: any = await this.prisma.vitalSignsHemodialysis.findMany(
        params,
      );
      return response;
    } catch (e) {
  ...
  async findUnique(params: Prisma.VitalSignsHemodialysisFindUniqueArgs) {
    try {
      const response: any = await this.prisma.vitalSignsHemodialysis.findUnique(
        params,
      );
      if (response === null) {
  ...
  async update(params: Prisma.VitalSignsHemodialysisUpdateArgs) {
    try {
      const response: any = await this.prisma.vitalSignsHemodialysis.update(
        params,
      );
      return response;
    } catch (e) {
  ...
  async delete(params: Prisma.VitalSignsHemodialysisDeleteArgs) {
    try {
      const response: any = await this.prisma.vitalSignsHemodialysis.delete(
        params,
      );
      return response;
    } catch (e) {
